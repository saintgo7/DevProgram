...
**Tech Stack**: React + Yahoo Finance API

## Description
Track stocks, performance, alerts.
...
1. **Clone and navigate:**
   ```bash
   cd WebApps/049_StockPortfolio_Stock_Portfolio_Tracker
   ```
...
```
049_StockPortfolio_Stock_Portfolio_Tracker/
