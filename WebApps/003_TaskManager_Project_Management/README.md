...
**Tech Stack**: Vue.js + Django + MySQL

## Description
Team collaboration tool with tasks, projects, timelines, and user assignments.
...
1. **Clone and navigate:**
   ```bash
   cd WebApps/003_TaskManager_Project_Management
   ```
...
```
003_TaskManager_Project_Management/
