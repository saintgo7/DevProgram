...
**Tech Stack**: Next.js + GraphQL + MongoDB

## Description
Social networking site with profiles, posts, likes, comments, and friend connections.
...
1. **Clone and navigate:**
   ```bash
   cd WebApps/004_SocialNetwork_Social_Media_Platform
   ```
...
```
004_SocialNetwork_Social_Media_Platform/
