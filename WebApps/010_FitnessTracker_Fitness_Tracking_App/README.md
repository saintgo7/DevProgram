...
**Tech Stack**: Vue.js + FastAPI + MongoDB

## Description
Track workouts, nutrition, goals, and progress charts.
...
1. **Clone and navigate:**
   ```bash
   cd WebApps/010_FitnessTracker_Fitness_Tracking_App
   ```
...
```
010_FitnessTracker_Fitness_Tracking_App/
