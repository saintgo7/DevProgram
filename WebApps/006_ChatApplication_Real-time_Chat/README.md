...
**Tech Stack**: Svelte + Socket.io + Redis

## Description
Real-time messaging with channels, direct messages, and file sharing.
...
1. **Clone and navigate:**
   ```bash
   cd WebApps/006_ChatApplication_Real-time_Chat
   ```
...
```
006_ChatApplication_Real-time_Chat/
