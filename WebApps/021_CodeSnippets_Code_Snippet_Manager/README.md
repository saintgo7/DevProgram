...
**Tech Stack**: Vue.js + Supabase

## Description
Save code snippets, syntax highlighting, tags.
...
1. **Clone and navigate:**
   ```bash
   cd WebApps/021_CodeSnippets_Code_Snippet_Manager
   ```
...
```
021_CodeSnippets_Code_Snippet_Manager/
